...
home-security: main.o devicehandler.o motionhandler.o ping.o homesecurity.o
	g++ main.o devicehandler.o motionhandler.o ping.o homesecurity.o -o home-security
